...
public class SimpleAES
{
    ...
    private const string initVector = "sedgyuvbnwerihgw";
...
public class SaveSystem : MonoBehaviour
{
    ...
    protected static string savePath = "/trueincrement.save";
    protected static string savePathBackUP = "/trueincrementbackup.save";
    ...
    public void ImportPlayer2(PersistentMain playerData)
    {
